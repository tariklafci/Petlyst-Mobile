  ...
  try {
    const query = `
      SELECT 
        ...
        c.clinic_opening_time AS clinic_opening_time,
        c.clinic_closing_time AS clinic_closing_time,
        c.clinic_establishment_year AS clinic_establishment_year,
        c.clinic_show_phone_number AS clinic_show_phone_number,
        c.clinic_show_mail_address AS clinic_show_mail_address,
        c.clinic_allow_online_meetings AS clinic_allow_online_meetings,
